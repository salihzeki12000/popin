...
class AdminSpace extends CI_Model {
	
	var $table = 'space_types';
	...
	public function deleteSpaceType($establishmentID)
	{
	...
	public function updateStatus($id = array(), $status)
	{
		...
		if($wrong == true)
		{
			return array("status"=>"NOT OK","message"=>"Selected Space Type Status Not Updated Sucessfully");
		}
		else
		{
			return array("status"=>"OK","message"=>"Selected Space Type Status Updated Successfully");
		}
	}
