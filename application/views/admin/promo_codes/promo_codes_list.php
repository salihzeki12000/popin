                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <div class="pull-right">
                                    <a href="<?= base_url(ADMIN_DIR . '/settings/add_promo_code'); ?>" class="btn btn-circle btn-info">
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="faq_category_list">
                                    <thead>
                                        <tr role="row" class="heading">
                                            ...
                                            <th width="10%"> Code </th>
                                            <th width="10%"> Discount<br/>(% off) </th>
        ...
        var faq_category_list = function () {
            ...
            grid.init({
                ...
                dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "ajax": {
                        "url": "<?= base_url(ADMIN_DIR . '/settings/get_all_promo_codes'); ?>", // ajax source
                    },
                    "order": [
                        [1, "desc"]
