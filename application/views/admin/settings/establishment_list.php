                        ...
                        <div class="portlet-body">
                            <div class="table-container">
                                ...
                                <div class="pull-right">
                                    <a href="<?= base_url(ADMIN_DIR . '/settings/add'); ?>" class="btn btn-circle btn-info">
                                        <i class="fa fa-plus"></i>
                                        <span> Add New Establishment Type </span>
                                    </a>
        ...
        var faq_category_list = function () {
            ...
            grid.init({
                ...
                dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                    ...
                    "ajax": {
                        "url": "<?= base_url(ADMIN_DIR . '/settings/get_all_establishment_list'); ?>", // ajax source
                    },
                    "order": [
                        [1, "asc"]
