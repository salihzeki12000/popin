...
class AdminSubscription extends CI_Model {

    var $table = 'subscription_master';
    var $select_fields = '*';
    var $where_condition = "id!='0'";
    var $column_order = array('id', 'code', 'name', 'details', 'amount', 'createdDate', 'updatedDate'); //set column field database for datatable orderable
    var $column_search = array('id', 'code', 'name', 'details', 'amount', 'createdDate', 'updatedDate'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    public function update_subscription_details($data) {
