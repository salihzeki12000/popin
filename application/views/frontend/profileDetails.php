        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    ?>
                    <span id="ErrorMessage" ></span> <button class="btn btn-success dropdown-toggle" type="button" id="addContact" aria-haspopup="true" aria-expanded="true">Add Contact<span class="caret"></span>
                          </button>
					<?php } 
                      }
					 ?>
...
$("#addContact").click(function() {
  var contactUserID = '<?php echo $customerID; ?>';
  $.ajax({
        ...
        success: function (response) {
           if (response == 1) {
             ...
             $('#ErrorMessage').html('<p>contact list has ben Added successfully</p>');
           }
