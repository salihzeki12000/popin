...
class PostedListing extends CI_Model {
    ...
    var $table = 'spaces';
    var $select_fields = 'id,industryType,establishmentType,spaceType,professionalCapacity,workSpaceCount,spaceTitle,currency,base_price,createdDate,isFeatured,status';
    ...
    private function get_datatables_query() {
        ...
        if (isset($_POST['isFeatured']) and $_POST['isFeatured'] != '') {
            $this->db->where('isFeatured', $_POST['isFeatured']);
        }
        if (isset($this->order)) {
            $order = $this->order;
