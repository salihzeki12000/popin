    ...
    <div class="container">
                                            ...
                                            <div class="portlet-body">
                                                <div class="table-container">
                                                     ...
                                                     <div class="pull-right">
                                                       <a href="<?= base_url(ADMIN_DIR.'/banner/add'); ?>" class="btn btn-circle btn-info">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover table-checkable" id="banner_list">
                                                        <thead>
                                                            ...
                                                            <tr role="row" class="filter">
                                                                <td> </td>
                                                                <td>
                                                                	<input type="text" class="form-control form-filter input-sm" name="caption">
                                                                </td>
                                                                <td></td>
                                                                <td>
        ...
        grid.init({
			...
			dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "<?= base_url(ADMIN_DIR.'/banner/get_all_list'); ?>", // ajax source
                },
                "order": [
                    [1, "asc"]
