<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box">
                        <form class="form-horizontal" role="form"  name="edit_page" id="edit_page" method="post" action="<?= base_url(ADMIN_DIR . '/pages/update_page/'); ?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="caption" class="col-sm-3 control-label">Page Name</label>
                                <div class="col-sm-9">
                                    <input type="text" placeholder="About Us" name="pageName" class="form-control" id="pageName" value="<?= $pageInfo->pageName; ?>"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="pageTitle" id="pageTitle" class="form-control" value="<?= $pageInfo->pageTitle; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="summernote" id="" name="pageContent">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="metaAuthor" id="metaAuthor" class="form-control" value="<?= $pageInfo->metaAuthor; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <img src="<?= base_url('uploads/page/thumb/' . $pageInfo->featuredImage); ?>" alt="<?= $pageInfo->pageName; ?>"><br><br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" id="status" class="form-control">
                                        <option value=""></option>
                                        <option value="Active" <?= ($pageInfo->status == 'Active') ? 'selected' : ''; ?>>Active</option>
                                        <option value="DeActive" <?= ($pageInfo->status == 'DeActive') ? 'selected' : ''; ?>>DeActive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <input type="hidden" id="oldFeaturedImage" name="OldFeaturedImage" value="<?= $pageInfo->featuredImage; ?>">
    ...
    <script>
        $(document).ready(function (e) {
            ...
            var validator = $("#edit_page").submit(function () {
