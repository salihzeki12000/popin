...
<section class="middle-container new-partner5 new-partner13">
        ...
        <div class="row clearfix">
            <div class="col-md-6 hi-cassiday">
                ...
                <div class="step step2">
                    ...
                    <a href="<?php echo site_url('Space/photos'); ?>" class="green-btn">Continue</a>
                </div>
    ...
    <div class="for-one">
        ...
        <p>For one week in <?= isset($stepData['step1']['page4']['city'])?$stepData['step1']['page4']['city']:"Fullerton";?> you could earn:</p>
