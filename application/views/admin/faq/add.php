                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                                <div class="card-box">
                        			<form class="form-horizontal" role="form"  name="add_faq" id="add_faq" method="post" action="<?= base_url(ADMIN_DIR.'/faq/add_faq/'); ?>" enctype="multipart/form-data">
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                  <select id="category" name="category" class="form-control select2">
                                                                    ...
                                                                    {
                                                                    ?>
                                                                    <option value="<?php echo $cat->id; ?>" <?= ($cat->status!='Active')?'disabled':''; ?>><?php echo $cat->name; ?></option>
                                                                    <?php } ?>                                                                   
                                                                </select>
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                  <input type="text" placeholder="Festival Offer On Christmas" name="question" class="form-control" id="question" value="">
	                                                </div>
	                                            </div>
												...
												<div class="form-group">
	                                                ...
	                                                <div class="col-sm-9">
	                                                 <textarea class="form-control input-sm"  name="answer" id="answer"></textarea>
	                                                </div>
	                                            </div>
